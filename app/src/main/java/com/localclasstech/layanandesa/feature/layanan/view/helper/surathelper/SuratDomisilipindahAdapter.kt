...
class SuratDomisilipindahAdapter(private var cardSuratList: List<DataClassCardSurat>,
                                 private val listener: OnAdapterListener
) : RecyclerView.Adapter<SuratDomisilipindahAdapter.ViewHolder>() {
    ...
    fun updateDataDomisiliPindah(newListDomisiliPindah: List<DataClassCardSurat>) {
        this.cardSuratList = newListDomisiliPindah
